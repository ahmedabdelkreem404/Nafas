...
class ContentSeeder extends Seeder
{
    public function run(): void
    {
        ...
        foreach ([
            ['slug' => 'faq', 'title' => 'FAQ', 'content' => 'أسئلة شائعة عن الشحن، التجربة، وسياسة الطلب.', 'is_active' => true],
            ...
            ['slug' => 'about', 'title' => 'About Nafas', 'content' => 'نفَس علامة عطور فاخرة تجمع بين الحضور، الحكاية، والانطباع.', 'is_active' => true],
            ['slug' => 'quality', 'title' => 'Quality', 'content' => 'عمليات مراجعة الجودة تشمل وضوح التجربة، التشطيب، وثبات الانطباع العطري دون وعود مبالغ فيها.', 'is_active' => true],
        ] as $page) {
