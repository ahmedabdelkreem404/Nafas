...
export const landingFragrances: LandingFragrance[] = [
  ...
  },
  {
    ...
    baseNotesAr: ['مسك هادئ', 'عنبر ظليل'],
    sizes: commonSizes,
    ctaLabel: 'Try Zell',
    ctaLabelAr: 'جرّب ظلّ',
  },
...
export const landingHighlights: LandingHighlight[] = [
  ...
  },
  {
    ...
    caption: 'Try the four moods before choosing your full bottle.',
    captionAr: 'جرّب الأربع روائح قبل ما تختار زجاجتك.',
...
export const landingChoiceCards: LandingChoiceCard[] = [
  ...
  },
  {
    id: 'choice-dafwa',
    fragranceId: 'dafwa',
    title: 'Go warmer with Dafwa',
    titleAr: 'اذهب للأدفأ مع دفوة',
  ...
  },
  {
    ...
    body: 'Try the four moods first, then return for the bottle that stays with you.',
    bodyAr: 'جرّب الأربع مودات أولًا، وبعدها ارجع للزجاجة التي تثبت معك.',
...
export const landingExploreCards: LandingExploreCard[] = [
  {
    ...
    body: 'See the four core scents together with sizes, testers, and gift options.',
    bodyAr: 'شاهد الأربع روائح الأساسية مع الأحجام، التستر، وخيارات الهدية.',
    href: '/shop',
  },
  {
    id: 'faq',
