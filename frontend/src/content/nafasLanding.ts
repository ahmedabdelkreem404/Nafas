...
export const landingHighlights: LandingHighlight[] = [
  ...
  },
  {
    ...
    caption: 'Try the six moods before choosing your full bottle.',
...
export const landingWhyCards: LandingWhyCard[] = [
  ...
  },
  {
    ...
    title: 'Six clear scent personalities',
    titleAr: 'ست شخصيات واضحة',
...
export const landingChoiceCards: LandingChoiceCard[] = [
  ...
  },
  {
    ...
    body: 'Try the six moods first, then return for the bottle that stays with you.',
    bodyAr: 'جرّب الست مودات أولًا، وبعدها ارجع للزجاجة التي تثبت معك.',
...
export const landingExploreCards: LandingExploreCard[] = [
  {
    ...
    body: 'See the six core scents together with sizes, testers, and gift options.',
